    ...
    <div class="menu">
        <ul>
            <li class="logo">
                ...
                <a href="#" target="_blank">Prodi Sistem Informasi - Universitas Widyatama</a>
            </li>
            <li class="menu-toggle">
                <button onclick="toggleMenu();">&#9776;</button>
            </li>
            <li class="menu-item hidden"><a href="base_url()">Home</a></li>
            <li class="menu-item hidden"><a href="" target="_blank">About Me</a>
            </li>
...
<!--  -->
    <div class="heroe">
        <h1>About Me</h1>
        <h2>Halo, perkenalkan saya Phasya. Saya berasal dari sebuah desa di Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita nesciunt nisi in nihil quos, iure consequuntur, deleniti, voluptatum dolor harum debitis dicta earum voluptatibus corrupti nulla! Quod soluta eveniet itaque!</h2>
    </div>
...
<section>
    ...
    <p>Halaman ini merupakan halaman terkait deskripsi singkat saya.</p>
</section>
